...
# Form implementation generated from reading ui file 'shixian.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(240, 40, 311, 41))
        font = QtGui.QFont()
        ...
        self.label_2.setGeometry(QtCore.QRect(70, 100, 430, 400))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(16)
        ...
        self.pushButton.setGeometry(QtCore.QRect(550, 170, 141, 41))
        font = QtGui.QFont()
        font.setFamily("楷体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "人体姿态识别应用"))
        self.label.setText(_translate("MainWindow", "OpenPose 人体姿态识别"))
        self.label_2.setText(_translate("MainWindow", "显示图片"))
        self.pushButton.setText(_translate("MainWindow", "打开图片"))
        self.pushButton_2.setText(_translate("MainWindow", "获得结果"))

    def openimage(self):
        global imgName
        imgName, imgType = QFileDialog.getOpenFileName(self.centralwidget, "打开图片", "", "*.jpg;;*.png;;All Files(*)")
        img = QtGui.QPixmap(imgName).scaled(self.label_2.width(), self.label_2.height())
        self.label_2.setPixmap(img)

    def startAction(self):
        # 根据路径输入图片
        image1 = cv2.imread(imgName)
        image2 = bilinear_interpolation(image1, (600, 600))
        self.frameWidth= image2.shape[1]
        self.frameHeight = image2.shape[0]
